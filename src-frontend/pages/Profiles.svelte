  ...
  <div class="card">
    ...
    <div class="settings-grid">
      ...
      <div class="setting-row"><div class="setting-info"><span class="setting-label">Model</span><span class="setting-desc">Larger = more accurate, slower. <button class="btn-link" onclick={() => { import("../lib/store").then(m => m.currentPage.set("models")); }}>Manage Models →</button></span></div>
        <select class="select" bind:value={e.trans_model}><option value="tiny">Tiny</option><option value="base">Base</option><option value="small">Small</option><option value="medium">Medium</option><option value="large-v3-turbo">Large v3 Turbo (Fast)</option><option value="large-v3">Large v3</option></select></div>
